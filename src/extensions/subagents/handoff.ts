...
export const handoffContract =
  'Report when the assignment is done or a blocker stops you. success means every acceptance criterion is met and checked; failure means it cannot be met; incomplete means a named blocker stops you: an external dependency, an exhausted limit, or a parent decision. Remaining steps are not a blocker. A report proves delivery, not correctness. Use these sections:\n' +
  ...
  '- Concerns: for an incomplete outcome, the blocker first; then unresolved risks, blocked checks, and any decision the parent must make. State a section as none or unavailable instead of omitting it.';
