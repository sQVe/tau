...
muted Latte palette with a dim gray directory, teal branch, and unchanged terminal background.
Extension statuses, including TDD feedback, no longer appear in the footer.
